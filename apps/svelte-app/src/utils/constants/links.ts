...
export const MAIN_ACCOUNT_USERS = '/main/users';
export const MAIN_ACCOUNT_ROLES = '/main/roles';
...
export const MAIN_ACCOUNT_USER_ID = (id: string) => MAIN_ACCOUNT_USERS + '/' + id;
export const MAIN_ACCOUNT_ROLE_ID = (id: string) => MAIN_ACCOUNT_ROLES + '/' + id;
