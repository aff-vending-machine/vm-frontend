...
<div class="relative p-2">
  <input
    ...
    maxlength={5}
    placeholder="hh:mm"
    class="border-2 border-gray-300 p-1 rounded-md text-center"
  />

  <div class="mt-2 grid grid-cols-2 divide-x divide-gray-200 overflow-hidden max-h-40">
    <div class="overflow-auto hide-scrollbar" style="max-height: 10rem;">
